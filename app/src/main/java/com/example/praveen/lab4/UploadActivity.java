...
public class UploadActivity extends AppCompatActivity {
        ...
        if (requestCode == 1) {
            if (resultCode == Activity.RESULT_OK) {
                try {
                    ...
                    //activate upload button only if selected image is not blank
    ...
    public void uploadPhoto(Uri selectedImage) {
        ...
        if(privateSwitch.isChecked()){
            ...
            imagePath = "image/private/"+userID+"/"+selectedImage.getLastPathSegment();
        }else{
            privacyState = "Public";
            imagePath = "image/public/"+userID+"/"+selectedImage.getLastPathSegment();
        }
